...
import net.tyconxon.offmod.procedures.BurntOnInitialEntitySpawnProcedure;
import net.tyconxon.offmod.itemgroup.OFFItemGroup;
import net.tyconxon.offmod.item.LuckTicketItem;
import net.tyconxon.offmod.entity.renderer.BurntRenderer;
...
public class BurntEntity extends OffmodModElements.ModElement {
	...
	public BurntEntity(OffmodModElements instance) {
		super(instance, 56);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BurntRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13421824, new Item.Properties().group(OFFItemGroup.tab))
				.setRegistryName("burnt_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.FOLLOW_RANGE, 25);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, CommonSpectreEntity.CustomEntity.class, true, true));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(LuckTicketItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("offmod:cowextract"));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			BurntOnInitialEntitySpawnProcedure.executeProcedure(Stream
