...
public class TroquantaryEntity extends OffmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.2000000000000002f, 3f)).build("troquantary").setRegistryName("troquantary");

	public TroquantaryEntity(OffmodModElements instance) {
		super(instance, 27);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TroquantaryRenderer.ModelRegisterHandler());
