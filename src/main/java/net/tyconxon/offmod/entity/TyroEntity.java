...
import net.tyconxon.offmod.procedures.TyroRightClickedOnEntityProcedure;
import net.tyconxon.offmod.itemgroup.EarthboundItemGroup;
import net.tyconxon.offmod.entity.renderer.TyroRenderer;
...
public class TyroEntity extends OffmodModElements.ModElement {
	...
	public TyroEntity(OffmodModElements instance) {
		super(instance, 58);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TyroRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -39322, -13395712, new Item.Properties().group(EarthboundItemGroup.tab))
				.setRegistryName("tyro_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 11);
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(9, new FollowOwnerGoal(this, 1, (float) 20, (float) 5, false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("offmod:hylicsspeech"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("offmod:hylicshit"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("offmod:womp"));
		}
