...
import net.tyconxon.offmod.entity.TiburceEntity;
...
@OnlyIn(Dist.CLIENT)
public class TiburceRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TiburceEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTiburceMDL(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("offmod:textures/entities/texture.png");
					}
				};
			});
		}
