...
import net.tyconxon.offmod.procedures.BurntEntityShakingConditionProcedure;
...
@OnlyIn(Dist.CLIENT)
public class BurntRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BurntEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelburntMDL(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("offmod:textures/entities/elsen_skin.png");
					}
					...
					protected boolean func_230495_a_(LivingEntity _ent) {
						...
						return BurntEntityShakingConditionProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
