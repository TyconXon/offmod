...
import net.tyconxon.offmod.entity.TroquantaryEntity;
...
@OnlyIn(Dist.CLIENT)
public class TroquantaryRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TroquantaryEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTroquantary(), 1.1f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("offmod:textures/entities/texture_3.png");
					}
				};
			});
		}
