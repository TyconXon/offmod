...
public class TiburceEntity extends OffmodModElements.ModElement {
	...
	public TiburceEntity(OffmodModElements instance) {
		super(instance, 53);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TiburceRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(OFFItemGroup.tab)).setRegistryName("tiburce_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, ElsenEntity.CustomEntity.class, true, false));
			...
			this.goalSelector.addGoal(6, new LookAtGoal(this, CatEntity.class, (float) 6));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.skeleton_horse.ambient"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TiburceEntityIsHurtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
