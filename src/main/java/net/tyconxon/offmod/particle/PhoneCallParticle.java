...
package net.tyconxon.offmod.particle;
...
public class PhoneCallParticle {
	...
	private static class CustomParticle extends SpriteTexturedParticle {
		...
		public void tick() {
			super.tick();
			if (!this.isExpired) {
				this.setSprite(this.spriteSet.get((this.age / 1) % 46 + 1, 46));
			}
		}
	}
